...
/**
 * Public method that is used to reduce the number
...
/**
 * Public method that is used to check the local similarity
 ...
 *     var tsp = new tsproc(ts, config, null);
 *
 *     //we can just merge the timeseries
...
/**
 * Private function that merges the configuration of 
