 ...
 * @class tsproc
 * @constructor
 * @param timeseries asdfasdf
 * @param config asdfdfdfdf
 * @param err_callback kjkjkj
 */
...
tsproc.prototype.getTimestamp = function(ts_index, doc_index){
	...
	if (this.isISO(ts_index))
		//return moment.utc(new Date(this._timeseries[ts_index][doc_index][this.getTimestampField(ts_index)]));
