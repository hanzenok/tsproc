...
tsproc.prototype.isISO = function(ts_index){
	...
	if(ts_index !== null || ts_index !== undefined){

		var format = this.getTimestampFormat(ts_index)
		...
		for (var i=0; i<n; i++){
			...
			if (this.getTimestampFormat(i) != ISO_FORMAT) //FIXME: it could be wrong
				return false;
		}
